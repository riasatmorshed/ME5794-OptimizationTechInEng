...
function gpr_func = objective_function(x);
...
%alpha = 1; l = 1.2; % Hyper-parameters to be optimized
%sigma2 = 1; % My guess for initial variance - can be changed to variance of training data or assumed as hyper-parameters
alpha = x(1); l = x(2); sigma2 = x(3);
...
Sigma_star = Kstarstar-Kstar'*inv(K+sigma2*eye(r,r))*Kstar+(sigma2*eye(t,t));
 ...
 gpr_func = norm(exp_Ystar-Ytest',2);
